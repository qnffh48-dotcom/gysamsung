...
function injectTempReservationStyle() {
    ...
    style.textContent = `
       ...
       .temp-reservation-table-box {
    padding: 12px;
    overflow-x: hidden !important;
}

#tempReservationTable {
    width: 100%;
...
#tempReservationTable input,
#tempReservationTable select {
    width: 100%;
    height: 22px;
    border: 0;
    padding: 0 3px;
...
#tempReservationTable .r-confirm {
    cursor: pointer;
    color: #166534;
    font-size: 15px;
    font-weight: 900;
...
#tempReservationTable th:nth-child(1) { width: 34px; }
#tempReservationTable th:nth-child(2) { width: 58px; }
#tempReservationTable th:nth-child(3) { width: 58px; }
#tempReservationTable th:nth-child(4) { width: 92px; }
#tempReservationTable th:nth-child(5) { width: 82px; }
#tempReservationTable th:nth-child(6) { width: 58px; }
#tempReservationTable th:nth-child(7) { width: 82px; }
#tempReservationTable th:nth-child(8) { width: 96px; }
#tempReservationTable th:nth-child(9) { width: 150px; }
#tempReservationTable th:nth-child(10) { width: 58px; }
#tempReservationTable th:nth-child(11) { width: 78px; }
#tempReservationTable th:nth-child(12) { width: 38px; }
        @media (max-width: 1200px) {
            ...
            #tempReservationTable { min-width: 0 !important; }
        }
    `;
